...
namespace Reciprocity.Migrations
{
    ...
    [Migration("20161003222727_LinkUserToRecipe")]
    partial class LinkUserToRecipe
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Reciprocity.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Reciprocity.Models.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Reciprocity.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("Reciprocity.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
        }
